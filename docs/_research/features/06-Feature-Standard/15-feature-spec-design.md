...
## Related Documents
- **Why Needed**: [The Execution Gap](../05-Feature-Engine/13-execution-gap.md) - Tại sao cần Dynamic Layer
- **Context Problem**: [Prompt Context Bottleneck](../05-Feature-Engine/14-prompt-context-bottleneck.md) - Tại sao cần Scoping
