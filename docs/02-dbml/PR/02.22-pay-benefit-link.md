...
> **Changed:** JUL 2025 (initial) | 07Apr2026 (Change 41: explicit FK columns `benefit_plan_id`, `pay_component_id`, `benefit_source`)
...
| `direction` | varchar(20) | Hướng tác động vào payroll | Xem enum |
